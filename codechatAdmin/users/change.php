...
if (isset($_POST['pseudo']) && !empty($_POST['pseudo']) && $_GET['type'] == 'pseudo'){
    ...
    if (!$checkExist){
        ...
        logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'SUCC', $_POST['pseudo']);
        header('location: ../manageUser.php?user=' . $pseudo . '&msg=username changed successfuly&err=false');
        exit();
    } else {
        logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'FAIL', 'already used');
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'FAIL', ' ');
...
if (isset($_POST['mail']) && !empty($_POST['mail'])){
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'SUCC', $_POST['mail']);
    header('location: ../manageUser.php?user='. $user . '&msg=Mail changed successfuly&err=false');
    exit();
} else if (empty($_POST['mail']) && $_GET['type'] == 'mail'){
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'FAIL', $_POST['mail']);
...
if (isset($_POST['firstName']) && !empty($_POST['firstName'])){
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'SUCC', $_POST['firstName']);
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'FAIL', $_POST['firstName']);
...
if (isset($_POST['lastName']) && !empty($_POST['lastName'])){
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'SUCC', $_POST['lastName']);
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'FAIL', $_POST['lastName']);
...
if (isset($_POST['postalCode']) && !empty($_POST['postalCode'])){
    ...
    if (is_numeric($postalCode) == 1){
        ...
        logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'SUCC', $postalCode);
        header('location: ../manageUser.php?user='. $user . '&msg=
        postalcode changed successfuly&err=false');
    } else {
        logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'FAIL', 'not numeric');
...
if (isset($_POST['city']) && !empty($_POST['city'])){
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'SUCC', $city);
...
if (isset($_POST['address']) && !empty($_POST['address'])){
    ...
    logAdmin('../../Logs/adminLogs/adminChangeUserLogs.txt', $_SESSION['admin'], $user, $_GET['type'], 'SUCC', $address);
